...
var M = {
    ...
    settings: {
      ...
      draw: function() {
          ...
          // slow fade BG colour
          M.ctx.shadowColor = 'rgba(0,0,0,0.7)';
      ...
      createCanvii: function(i) {
          ...
          for (var j = 1; j < codeLen; j++) {
              ...
              if (j < 5) {
                  newCtx.shadowColor = 'hsl(104, 79%, 79%)';
                  newCtx.shadowOffsetX = 0;
                  newCtx.shadowOffsetY = 0;
                  newCtx.shadowBlur = 10;
                  newCtx.fillStyle = 'hsla(104, 80%, ' + (100 - (j * 5)) + '%, ' + strength + ')';
              } else if (j > (codeLen - 4)) {
                  ...
                  newCtx.shadowOffsetY = 0;
                  newCtx.shadowBlur = 0;
                  newCtx.fillStyle = 'hsla(104, 79%, 73%, ' + (fadeStrength + 0.1) + ')';
              } else {
                  newCtx.shadowOffsetX = 0;
                  newCtx.shadowOffsetY = 0;
                  newCtx.shadowBlur = 0;
                  newCtx.fillStyle = 'hsla(104, 79%, 73%, ' + strength + ')';
              }
